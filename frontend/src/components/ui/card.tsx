...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn(
				'flex items-center rounded-none border-t border-dashed border-border p-4 group-data-[size=sm]/card:p-3',
				className,
			)}
			{...props}
		/>
